...
Item {
    ...
    LazyListView.preferredWidth: LazyListView.removing ? 0 : layout.implicitWidth + (hasWindows ? Tokens.padding.extraSmall : 0)
    ...
    Component {
        ...
        MaterialShape {
            implicitSize: Tokens.sizes.bar.innerHeight - Tokens.padding.small
    ...
    RowLayout {
        ...
        Loader {
            ...
            Layout.preferredWidth: root.hasWindows && item ? (item as LazyListView).layoutWidth : 0
